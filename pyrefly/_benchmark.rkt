...
(define current-typechecker-symbol 'pyrefly)
(define current-typechecker-name "pyrefly")
...
(define typechecker-parameters
  `((name ,current-typechecker-name)
    ...
    (arguments ,(list "main.py" "run" "pyrefly" "check"))
    (examples-arguments ,(list "examples.py" "run" "pyrefly" "check"))
    (command "uv")))
